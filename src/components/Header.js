...
function Header() {
  //dictacts when navbackground appears
  ...
  return (
    <header ref={ref} id="home" className="header">
      <nav id="nav-wrap" className={inView ? 'nav-light' : 'nav-dark'}>
      ...
      <div className="home-banner">
        <div className="banner-text">
          ...
          <a href='https://github.com/SamJones1995' target="_blank">
            ...
            <a href='https://twitter.com/SamuelJonesDev' target="_blank">
            <svg
              className="icon-img-head"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
            ...
            <a href='https://www.linkedin.com/in/samuel-jones-b9925687' target="_blank">
            <svg
              className="icon-img-head"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 448 512"

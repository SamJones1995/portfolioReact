      ...
      <div className="row education">
          ...
          <div className='education-content'>
            ...
            <div className='education-text'>
              ...
              <p>My foreray into higher education was completed online in March of 2020. 
                I left high school with an interest in aviation but training costs and the 
                rigid lifestyle requirements eventually led me to take another path into tech.
                Regardless I completed the degree and am still very knowledgeable in the field and 
          ...
          <div className='education-content'>
            ...
            <div className='education-text'>
              ...
              <p>This is the course that molded me into a programmer. It was a fantastic journey that I completed with the help of 
                tutors and mentors who are professionals in the industry. Learning from them and my peers I managed to complete the course
                projects (with my own personal spins) and earn my certificate.
              </p>
            </div>
